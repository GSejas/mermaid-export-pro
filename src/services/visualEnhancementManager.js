...
exports.VisualEnhancementManager = void 0;
...
class VisualEnhancementManager {
    context;
    static ENHANCEMENT_KEY = 'mermaidExportPro.visualEnhancements';
    constructor(context) {
    ...
    getEnhancementOptions() {
        ...
        const enhancements = config.get('visualEnhancements', {});
        return {
     ...
     */
    enhanceExportOptions(baseOptions) {
     ...
     */
    async postProcessSvg(svg, options) {
        if (!options.enabled) {
            return svg;
        }
        ...
        return {
            ...
            <linearGradient id="premium-accent" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <stop offset="100%" style="stop-color:#EA580C;stop-opacity:1" />
                ...
                const currentGradients = gradientSets[options.style] || gradientSets.modern;
    ...
    createRoundedCornersProcessor() {
        return {
            ...
            process: (svg, options) => {
                ...
                const radius = radiusMap[options.style] || '8';
                return svg
    ...
    createProfessionalStylingProcessor() {
        return {
    ...
    createArtisticEffectsProcessor() {
        return {
    ...
    getTypographyConfig(typography) {
        ...
        return typographyConfigs[typography] || typographyConfigs.default;
    }
...
exports.VisualEnhancementManager = VisualEnhancementManager;
//# sourceMappingURL=visualEnhancementManager.js.map