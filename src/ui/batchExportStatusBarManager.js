...
exports.batchExportStatusBar = exports.BatchExportStatusBarManager = void 0;
 ...
 */
class BatchExportStatusBarManager {
    statusBarItem;
    animationBarItem;
    animationTimer;
    ...
    constructor() {
        ...
        this.statusBarItem = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 1000 // High priority to appear near the left
        );
        // Create separate animated progress bar item (positioned to the right of main item)
        this.animationBarItem = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 999 // Slightly lower priority so it appears to the right
        );
        // Set up click handler for cancellation on main item
        this.statusBarItem.command = 'mermaidExportPro.cancelBatchExport';
        errorHandler_1.ErrorHandler.logInfo('BatchExportStatusBarManager initialized with separate animation bar');
    }
    /**
     * Start showing the status bar item and begin animation for a export folder operation
     */
    startBatchExport(cancelCallback) {
        ...
        errorHandler_1.ErrorHandler.logInfo('BatchExportStatusBarManager: Started export folder display');
    }
    /**
     ...
     */
    completeBatchExport(success, finalMessage, duration) {
        if (!this.isActive)
            return;
        ...
        errorHandler_1.ErrorHandler.logInfo(`BatchExportStatusBarManager: Completed export folder (success: ${success})`);
    }
    /**
    ...
    cancelBatchExport() {
        ...
        errorHandler_1.ErrorHandler.logInfo('BatchExportStatusBarManager: Cancelled export folder');
    }
    /**
    ...
    hideBatchExport() {
        ...
        errorHandler_1.ErrorHandler.logInfo('BatchExportStatusBarManager: Hidden export folder display');
    }
    /**
    ...
    dispose() {
        ...
        errorHandler_1.ErrorHandler.logInfo('BatchExportStatusBarManager disposed');
    }
    /**
     ...
     */
    getBackgroundColorForPhase(phase) {
     ...
     */
    getTooltipForPhase(phase, message) {
...
exports.BatchExportStatusBarManager = BatchExportStatusBarManager;
/**
 * Singleton instance for global access
 */
exports.batchExportStatusBar = new BatchExportStatusBarManager();
//# sourceMappingURL=batchExportStatusBarManager.js.map