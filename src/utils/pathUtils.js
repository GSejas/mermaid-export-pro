...
class PathUtils {
     ...
     */
    static generateOutputPath(inputPath, format, outputDir) {
     ...
     */
    static async getUniqueFilePath(targetPath) {
     ...
     */
    static createTempFilePath(extension) {
     ...
     */
    static getDisplayPath(fullPath, workspaceRoot) {
        if (workspaceRoot) {
